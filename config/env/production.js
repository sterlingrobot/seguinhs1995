...
module.exports = {
	...
	mailer: {
		from: process.env.MAILER_FROM || 'SHS Class of 1995 <seguinhs1995@gmail.com>',
		options: {
			service: process.env.MAILER_SERVICE_PROVIDER || 'gmail',
			auth: {
				user: process.env.MAILER_EMAIL_ID || 'seguinhs1995@gmail.com',
				pass: process.env.MAILER_PASSWORD || 'Matadors95!'
			}
		}
	}
};
